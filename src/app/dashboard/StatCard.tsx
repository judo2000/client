...
const StatCard = ({
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between">
      ...
      {/* BODY */}
      <div className="flex mb-6 items-center justify-around gap-4 px-4">
        <div className="rounded-ful p-5 bg-blue-50 border-sky-300 border-[1px]">
          {primaryIcon}
        </div>
            ...
            <React.Fragment key={index}>
              <div className="flex items-center justify-between my-4">
                ...
                <div className="flex items-center">
                  ...
                  <span
                    className={`font-md ${getChangeColor(
                      detail.changePercentage
                    )}`}
                  >
